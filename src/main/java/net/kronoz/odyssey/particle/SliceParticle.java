...
public class SliceParticle extends SpriteBillboardParticle {
    ...
    public SliceParticle(ClientWorld clientWorld, double x, double y, double z,
...
//        float finalScale =  MathHelper.lerp(lifeProgress, PARTICLE_SCALE, PARTICLE_SCALE * 0.2f);
    ...
    public static class Factory implements ParticleFactory<SimpleParticleType> {
        ...
        public @Nullable Particle createParticle(SimpleParticleType parameters, ClientWorld world, double x, double y, double z, double velocityX, double velocityY, double velocityZ) {
            return new SliceParticle(world, x, y, z, this.spriteProvider, velocityX, velocityY, velocityZ);
        }
    }
}
